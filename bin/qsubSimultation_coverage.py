...
if isunsym:
	...
	#allcoverages = [3000]
	allcoverages = []
	allcoverages.extend(range(10, 100, 10))
	allcoverages.extend(range(100, 1000, 100));
	allcoverages.extend(range(1000, (3000+1), 1000));
	#allcoverages.extend(range(1000, (3000-1), 1000));
	#allcoverages.extend(range(1000, (10000-1), 1000))
	print allcoverages

	for coverage_ind in range(len(allcoverages)):
		coverage = allcoverages[coverage_ind]
		if coverage_ind==0: pre_coverage = 0;
		else: pre_coverage = allcoverages[coverage_ind-1]
                if (not ispcr):# /home/qianliu/HTT_CAG_repeat
                        #cmd = "echo 'python trinucleotideRepeatRealSimulation_main.py -repeatgene "+glk+" --UnsymAlign 1 --align 1 --updown 18 --extend 0 --randTimes "+str(randtimes)+" --coverage "+str(coverage)+" > logsim/repeatgenes_"+glk+"_unsymalign_align_updn18_nonext_errorDef_coverage"+str(coverage)+"_time"+str(randtimes)+".log' | qsub -V -cwd -pe smp 1 -l h_vmem=5G -e /home/qianliu/project/HTT_CAG_repeat/nohup -o /home/qianliu/project/HTT_CAG_repeat/nohup -N trirep_unsym_"+glk+"_"+str(coverage)+" -hold_jid " + "trirep_unsym_"+glk+"_"+str(coverage)+'_pcr1'+" -hold_jid trirep_"+glk+"_"+str(coverage)+"_align_updn120_ext6_errorDef_pcr1"
                        cmd = "echo 'python trinucleotideRepeatRealSimulation_main.py -repeatgene "+glk+" --UnsymAlign 1 --align 1 --updown 18 --extend 0 --randTimes "+str(randtimes)+" --coverage "+str(coverage)+" > logsim/repeatgenes_"+glk+"_unsymalign_align_updn18_nonext_errorDef_coverage"+str(coverage)+"_time"+str(randtimes)+".log' | qsub -V -cwd -pe smp 1 -l h_vmem=8G -e /home/qianliu/HTT_CAG_repeat/nohup -o /home/qianliu/HTT_CAG_repeat/nohup -N trirep_unsym_"+glk+"_"+str(coverage)+" -hold_jid " + "trirep_unsym_"+glk+"_"+str(coverage)+'_pcr1'+" -hold_jid trirep_"+glk+"_"+str(coverage)+"_align_updn120_ext6_errorDef_pcr1 -hold_jid trirep_unsym_"+glk+"_"+str(pre_coverage)+" -hold_jid trirep_unsym_"+glk+"_"+str(allcoverages[-1])+'_pcr1'
                        #cmd = "echo 'python trinucleotideRepeatRealSimulation_main.py -repeatgene "+glk+" --UnsymAlign 1 --align 1 --updown 18 --extend 0 --randTimes "+str(randtimes)+" --coverage "+str(coverage)+" > logsim/repeatgenes_"+glk+"_unsymalign_align_updn18_nonext_errorDef_coverage"+str(coverage)+"_time"+str(randtimes)+".log' | qsub -V -cwd -pe smp 1 -l h_vmem=8G -e /home/qianliu/HTT_CAG_repeat/nohup -o /home/qianliu/HTT_CAG_repeat/nohup -N trirep_unsym_"+glk+"_"+str(coverage)+" -hold_jid " + "trirep_unsym_"+glk+"_"+str(coverage)+'_pcr1'+" -hold_jid trirep_"+glk+"_"+str(coverage)+"_align_updn120_ext6_errorDef_pcr1"+" -hold_jid trirep_unsym_"+glk+"_"+str(allcoverages[-1])+'_pcr1'
                else:
                        ...
                        cmd = "echo 'python trinucleotideRepeatRealSimulation_main.py -repeatgene "+glk+" --UnsymAlign 1 --align 1 --updown 18 --extend 0 --randTimes "+str(randtimes)+" --coverage "+str(coverage)+" --UserDefinedGene /92070888/92072403///// --UserDefinedGeneName pcr1 > logsim/repeatgenes_"+glk+"_pcr1_unsymalign_align_updn18_nonext_errorDef_coverage"+str(coverage)+"_time"+str(randtimes)+".log' |  qsub -V -cwd -pe smp 1 -l h_vmem=8G -e /home/qianliu/HTT_CAG_repeat/nohup -o /home/qianliu/HTT_CAG_repeat/nohup -N trirep_unsym_"+glk+"_"+str(coverage)+'_pcr1 -hold_jid trirep_unsym_'+glk+"_"+str(pre_coverage)+'_pcr1'
