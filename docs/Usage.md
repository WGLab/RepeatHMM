...
```
where `hg38/hg38.fa` is the hg38 human reference genome. To run the example above, users need to install `fastq-dump` and then use `fastq-dump SRR5363632` to download fastq file to `SRR5363632.fastq`. 
